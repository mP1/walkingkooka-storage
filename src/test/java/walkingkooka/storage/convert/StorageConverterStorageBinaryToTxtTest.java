...
public final class StorageConverterStorageBinaryToTxtTest extends StorageConverterStorageBinaryToTestCase<StorageConverterStorageBinaryToTxt<FakeStorageConverterContext>> {
    ...
    @Override
    public StorageConverterStorageBinaryToTxt<FakeStorageConverterContext> createConverter() {
    ...
    @Override
    public Class<StorageConverterStorageBinaryToTxt<FakeStorageConverterContext>> type() {
        return Cast.to(StorageConverterStorageBinaryToTxt.class);
    }
}
