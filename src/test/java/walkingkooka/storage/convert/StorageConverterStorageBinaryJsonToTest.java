...
public final class StorageConverterStorageBinaryJsonToTest extends StorageConverterStorageBinaryTestCase<StorageConverterStorageBinaryJsonTo<FakeStorageConverterContext>> {
    ...
    @Override
    public StorageConverterStorageBinaryJsonTo<FakeStorageConverterContext> createConverter() {
        return StorageConverterStorageBinaryJsonTo.instance();
    }
    ...
    @Override
    public Class<StorageConverterStorageBinaryJsonTo<FakeStorageConverterContext>> type() {
        return Cast.to(StorageConverterStorageBinaryJsonTo.class);
    }
}
