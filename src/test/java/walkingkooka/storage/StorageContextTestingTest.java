...
public final class StorageContextTestingTest implements StorageContextTesting,
    ...
    public void testStorageContextConstant() {
        this.checkEquals(
            "application/octet-stream {charset=UTF-8, currency=AUD, currentWorkingDirectory=/current1/working2/directory3, homeDirectory=/home/user/, indentation=\"  \", lineEnding=\"\\n\", locale=en_AU, timeOffset=Z, user=user123@example.com}",
    ...
    public void testDifferentStorageContextConstant() {
        this.checkEquals(
            "application/octet-stream {charset=ISO-8859-1, currency=NZD, currentWorkingDirectory=/different/current1/working2/directory3, homeDirectory=/home/different-user/, indentation=\"    \", lineEnding=\"\\r\\n\", locale=en_NZ, timeOffset=Z, user=different-user-456@example.com}",
